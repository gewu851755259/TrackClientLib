...
public class PreferencesUtils {
    ...
    public static final int MIN_RECORDING_DISTANCE_DEFAULT = 2;
    ...
    public static final String TRACK_COLOR_MODE_DEFAULT = "DYNAMIC";
    ...
    public static final int DEFAULT_TRACK_PAUSE_TOTAL_TIME = -1;
    ...
    public static boolean getBoolean(Context context, String keyStr, boolean defaultValue) {
        SharedPreferences sharedPreferences = context
                .getSharedPreferences(Constant.SETTINGS_NAME, Context.MODE_PRIVATE);
        return sharedPreferences.getBoolean(keyStr, defaultValue);
    }
    ...
    @SuppressLint("CommitPrefEdits")
    public static void setBoolean(Context context, String keyStr, boolean value) {
        SharedPreferences sharedPreferences = context
                .getSharedPreferences(Constant.SETTINGS_NAME, Context.MODE_PRIVATE);
    ...
    public static long getLong(Context context, String keyStr) {
        SharedPreferences sharedPreferences = context
                .getSharedPreferences(Constant.SETTINGS_NAME, Context.MODE_PRIVATE);
        return sharedPreferences.getLong(keyStr, -1L);
    }
    ...
    @SuppressLint("CommitPrefEdits")
    public static void setLong(Context context, String keyStr, long value) {
        SharedPreferences sharedPreferences = context
                .getSharedPreferences(Constant.SETTINGS_NAME, Context.MODE_PRIVATE);
        Editor editor = sharedPreferences.edit();
        editor.putLong(keyStr, value);
        editor.apply();
        // ApiAdapterFactory.getApiAdapter().applyPreferenceChanges(editor);
    }
    ...
    /**
     * Gets a array string preference value.
     */
    public static Set<String> getArrayString(Context context, int keyId) {
        SharedPreferences sharedPreferences = context
                .getSharedPreferences(Constant.SETTINGS_NAME, Context.MODE_PRIVATE);
        return new HashSet<>(sharedPreferences.getStringSet(getKey(context, keyId), new HashSet<>()));
    }

    /**
     * Sets a array string preference value.
     */
    public static void setArrayString(Context context, int keyId, Set<String> value) {
        SharedPreferences sharedPreferences = context
                .getSharedPreferences(Constant.SETTINGS_NAME, Context.MODE_PRIVATE);
        Editor editor = sharedPreferences.edit();
