...
public class StringUtils {
    ...
    public static String formatElapsedTime(long time) {
        /*
         * Temporary workaround for DateUtils.formatElapsedTime(time / 1000). In
         * API level 17, it returns strings like "1:0:00" instead of "1:00:00",
         * which breaks several unit tests.
         */
     ...
     */
    public static String formatSpeed(Context context, double speed, boolean metricUnits, boolean reportSpeed) {
     ...
     * @param formatArgs
     *            the string resource ids of the format arguments
     */
