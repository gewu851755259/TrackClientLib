...
interface ITrackRecordingService {
   ...
   */
  long startNewTrackWithAppInfo(in String appId, in String appName);
  ...
  /**
   * Pauses the current recording track with appid.
   */
  void pauseCurrentTrackWithAppId(in String appId);
  ...
  /**
   * Resumes the current recording track with appid.
   */
  void resumeCurrentTrackWithAppId(in String appId);
  ...
  /**
   * Ends the current recording track with appid.
   */
  void endCurrentTrackWithAppId(in String appId);
  ...
  /**
   * Returns true if currently recording a track with appid.
   */
  boolean isRecordingWithAppId(in String appId);
  ...
  /**
   * Returns true if the current recording track is paused. Returns true if not recording with appid.
   */
  boolean isPausedWithAppId(in String appId);
  ...
  /**
   * Gets the current recording track ID. Returns -1 if not recording with appid.
   */
  long getRecordingTrackIdWithAppId(in String appId);
