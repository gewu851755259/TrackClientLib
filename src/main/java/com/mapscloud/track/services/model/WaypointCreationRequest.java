...
public class WaypointCreationRequest implements Parcelable {
    ...
    public final static WaypointCreationRequest DEFAULT_WAYPOINT = new WaypointCreationRequest(WaypointType.WAYPOINT,
            false);
    ...
    public WaypointCreationRequest(WaypointType type, boolean isTrackStatistics, String name, String category,
    ...
    public static class Creator implements Parcelable.Creator<WaypointCreationRequest> {
        ...
        public WaypointCreationRequest createFromParcel(Parcel source) {
            WaypointCreationRequest request = new WaypointCreationRequest(WaypointType.values()[source.readInt()],
                    source.readByte() == 1, source.readString(), source.readString(), source.readString(),
                    source.readString());
            return request;
        }
