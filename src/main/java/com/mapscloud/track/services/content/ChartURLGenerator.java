...
import com.mapscloud.track.services.utils.ChartsExtendedEncoder;
...
public class ChartURLGenerator {
     ...
     * @param elevations
     *            A matching array of elevation measurements
     * @param track
     *            The track for this chart
     * @param context
     *            The current appplication context
     */
    public static String getChartUrl(Vector<Double> distances, Vector<Double> elevations, Track track, Context context) {
        boolean metricUnits = PreferencesUtils.getBoolean(context, R.string.metric_units_key,
                PreferencesUtils.METRIC_UNITS_DEFAULT);
        return getChartUrl(distances, elevations, track, context.getString(R.string.stats_elevation), metricUnits);
    }
     ...
     * @param metricUnits
     *            Should the data be displayed in metric units
     */

    static String getChartUrl(Vector<Double> distances, Vector<Double> elevations, Track track, String title,
            boolean metricUnits) {
