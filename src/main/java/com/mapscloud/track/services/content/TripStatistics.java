...
import com.mapscloud.track.services.tracks.ExtremityMonitor;
...
public class TripStatistics implements Parcelable {
    ...
    // The trip start time. This is the system time, might not match the GPs
    // time.
    private long startTime = -1L;

    // The trip stop time. This is the system time, might not match the GPS
    // time.
    ...
    // The total moving time (ms). Based on when we believe the user is
    // traveling.
     ...
     *
     * @param other
     *            another statistics data object to copy from
     */
    ...
    /**
     * Combines these statistics with those from another object. This assumes
     * that the time periods covered by each do not intersect.
     *
     * @param other
     *            another statistics data object
     */
    ...
    /**
     * Gets the minimum elevation. This is calculated from the smoothed
     * elevation so this can actually be more than the current elevation.
     */
    ...
    /**
     * Gets the maximum elevation. This is calculated from the smoothed
     * elevation so this can actually be less than the current elevation.
     */
     ...
     *
     * @param startTime
     *            the trip start time in milliseconds since the epoch
     */
     ...
     *
     * @param stopTime
     *            the stop time in milliseconds since the epoch
     */
     ...
     *
     * @param totalTime
     *            the trip total time in milliseconds
     */
     ...
     *
     * @param movingTime
     *            the trip total moving time in milliseconds
     */
    ...
    /**
     * Sets the bounding box for this trip. The unit for all parameters is
     * signed millions of degree (degrees * 1E6).
     *
     * @param leftE6
     *            the leftmost longitude reached
     * @param topE6
     *            the topmost latitude reached
     * @param rightE6
     *            the rightmost longitude reached
     * @param bottomE6
     *            the bottommost latitude reached
     */
     ...
     *
     * @param latitude
     *            the latitude value in signed decimal degrees
     */
     ...
     *
     * @param longitude
     *            the longitude value in signed decimal degrees
     */
     ...
     *
     * @param grade
     *            the grade as a fraction (-1.0 would mean vertical downwards)
     */
     ...
     *
     * @param grade
     *            the grade as a fraction (1.0 would mean vertical upwards)
     */
    ...
    public String toString() {
        return "TripStatistics { Start Time: " + getStartTime() + "; Stop Time: " + getStopTime() + "; Total Time: "
                + getTotalTime() + "; Total Distance: " + getTotalDistance() + "; Total Time: " + getTotalTime()
                + "; Moving Time: " + getMovingTime() + "; Min Latitude: " + getBottomDegrees() + "; Max Latitude: "
                + getTopDegrees() + "; Min Longitude: " + getLeftDegrees() + "; Max Longitude: " + getRightDegrees()
                + "; Max Elevation: " + getMaxElevation() + "; Max Speed: " + getMaxSpeed() + "; Min Elevation: "
                + getMinElevation() + "; Max Elevation: " + getMaxElevation() + "; Elevation Gain: "
                + getTotalElevationGain() + "; Min Grade: " + getMinGrade() + "; Max Grade: " + getMaxGrade() + "}";
    }
