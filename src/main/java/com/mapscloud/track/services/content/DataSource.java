...
import com.mapscloud.track.services.model.MyTracksLocationManager;
...
public class DataSource {
    ...
    private static final int NETWORK_PROVIDER_MIN_TIME = 5 * 60 * 1000; // 5
                                                                        // minutes
    ...
    public DataSource(Context context) {
        ...
        sharedPreferences = context.getSharedPreferences(Constant.SETTINGS_NAME, Context.MODE_PRIVATE);
    }
    ...
    public void registerLocationListener(LocationListener listener) {
        ...
        myTracksLocationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER,
                0, 0, listener, context.getMainLooper());
        ...
        try {
            myTracksLocationManager.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, NETWORK_PROVIDER_MIN_TIME,
                    0, listener, context.getMainLooper());
    ...
    private boolean isLocationRecent(Location location) {
        ...
        return location.getTime() > System.currentTimeMillis() - Constant.MAX_LOCATION_AGE_MS;
    }
