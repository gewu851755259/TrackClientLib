...
import com.mapscloud.track.services.utils.StringUtils;
...
public class DescriptionGeneratorImpl implements DescriptionGenerator {
    ...
    @Override
    public String generateTrackDescription(Track track, Vector<Double> distances, Vector<Double> elevations,
            boolean html) {
        ...
        // Created by
        String beginAnchor = html ? "<a href='http://" + context.getString(R.string.my_tracks_web_url) + "'>" : "";
        ...
        writeString(track.name, builder, R.string.generic_name_line, lineBreak);
        writeString(track.category, builder, R.string.description_activity_type, lineBreak);
        writeString(track.description, builder, R.string.generic_description_line, lineBreak);
     ...
     *            the string builder
     * @param resId
     *            the resource id containing one string placeholder
     * @param lineBreak
     *            the line break
     */
    ...
    private String generateTripStatisticsDescription(TripStatistics stats, boolean html) {
        ...
        // Average speed
        Pair<Double, Double> averageSpeed = writeSpeed(stats.getAverageSpeed(), builder,
                R.string.description_average_speed, lineBreak);
        ...
        // Max speed
        Pair<Double, Double> maxSpeed = writeSpeed(stats.getMaxSpeed(), builder, R.string.description_max_speed,
                lineBreak);
        ...
        // Recorded time
        builder.append(context.getString(R.string.description_recorded_time,
     ...
     * @param resId
     *            resource id of distance string
     * @param lineBreak
     *            line break string
     */
     ...
     * @param builder
     *            StringBuilder to append time
     * @param resId
     *            resource id of time string
     * @param lineBreak
     *            line break string
     */
     ...
     * @param builder
     *            StringBuilder to append speed
     * @param resId
     *            resource id of speed string
     * @param lineBreak
     *            line break string
     * @return a pair of speed, first in kilometers per hour, second in miles
     *         per hour.
     */

    Pair<Double, Double> writeSpeed(double speed, StringBuilder builder, int resId, String lineBreak) {
     ...
     * 
     * @param speed
     *            a pair of speed, first in kilometers per hour, second in miles
     *            per hour
     * @param builder
     *            StringBuilder to append pace
     * @param resId
     *            resource id of pace string
     * @param lineBreak
     *            line break string
     */

    void writePace(Pair<Double, Double> speed, StringBuilder builder, int resId, String lineBreak) {
     ...
     *            elevation in meters
     * @param builder
     *            StringBuilder to append elevation
     * @param resId
     *            resource id of elevation string
     * @param lineBreak
     *            line break string
     */
     ...
     *            grade in fraction
     * @param builder
     *            StringBuilder to append grade
     * @param resId
     *            resource id grade string
     * @param lineBreak
     *            line break string
     */
