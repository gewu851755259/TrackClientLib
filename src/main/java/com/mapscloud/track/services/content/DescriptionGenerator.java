...
public interface DescriptionGenerator {
     ...
     *            the track
     * @param distances
     *            a vector of distances to generate the elevation chart
     * @param elevations
     *            a vector of elevations to generate the elevation chart
     * @param html
     *            true to output html, false to output plain text
     */
