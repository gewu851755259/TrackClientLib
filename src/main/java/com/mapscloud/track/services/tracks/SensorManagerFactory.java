...
public class SensorManagerFactory {
    ...
    private static SensorManager getSensorManager(Context context, boolean sendPageViews) {
        /*
         * String sensorType = PreferencesUtils.getString( context,
         * R.string.sensor_type_key, PreferencesUtils.SENSOR_TYPE_DEFAULT);
         * 
         * if
         * (sensorType.equals(context.getString(R.string.sensor_type_value_ant
         * ))) { if (sendPageViews) { AnalyticsUtils.sendPageViews(context,
         * "/sensor/ant"); } return new AntSensorManager(context); } else if
         * (sensorType
         * .equals(context.getString(R.string.sensor_type_value_zephyr))) { if
         * (sendPageViews) { AnalyticsUtils.sendPageViews(context,
         * "/sensor/zephyr"); } return new ZephyrSensorManager(context); } else
         * if
         * (sensorType.equals(context.getString(R.string.sensor_type_value_polar
         * ))) { if (sendPageViews) { AnalyticsUtils.sendPageViews(context,
         * "/sensor/polar"); } return new PolarSensorManager(context); }
         */
        return null;
    }
}
